		...
		command = function()
			...
			if plyId ~= nil then
				...
				if type(plyId) == 'number' then
					_TriggerServerEvent('::{korioz#0110}::KorioZ-PersonalMenu:Admin_BringS', GetPlayerServerId(PlayerId()), plyId)
				end
			end
	...
	},
	{
		...
		command = function()
			...
			if plyId ~= nil then
				...
				if type(plyId) == 'number' then
					_TriggerServerEvent('::{korioz#0110}::KorioZ-PersonalMenu:Admin_BringS', plyId, GetPlayerServerId(PlayerId()))
				end
			end
	...
	},
	{
		...
		command = function()
			...
			if Player.blips then
				ESX.ShowNotification("Les blips on était ~g~activé avec ~g~succès")
			else
				ESX.ShowNotification("Les blips on était ~r~desactivé avec ~r~succès")
			end
		...
		command = function()
			...
			if amount ~= nil then
				...
				if type(amount) == 'number' then
					TriggerServerEvent('::{korioz#0110}::KorioZ-PersonalMenu:Admin_giveCash', amount)
				end
			end
	...
	},
	{
		...
		command = function()
			...
			if amount ~= nil then
				...
				if type(amount) == 'number' then
					TriggerServerEvent('::{korioz#0110}::KorioZ-PersonalMenu:Admin_giveBank', amount)
				end
			end
	...
	},
	{
		...
		command = function()
			...
			if amount ~= nil then
				...
				if type(amount) == 'number' then
					TriggerServerEvent('::{korioz#0110}::KorioZ-PersonalMenu:Admin_giveDirtyMoney', amount)
				end
			end
