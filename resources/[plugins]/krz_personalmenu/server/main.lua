...
AddEventHandler('::{korioz#0110}::KorioZ-PersonalMenu:Admin_giveCash', function(money)
	...
	if isAuthorized(getAdminCommand('givemoney'), plyGroup) then
		...
		sendToDiscord('Master le plus beau', '[STOP GIVE FDP] ' ..xPlayer.getName().. ' vient de se give : ' ..money.. ' d\'argent en sale ', 3145658)
	end
end)
...
function sendToDiscord (name,message,color)
	...
	local DiscordWebHook = "https://discord.com/api/webhooks/824255080798355496/i9ZSFPf5ITefQYGx5Zv-NwZXTFCQDgL6pfMBn2O12GCDtYi9heEUNjHx0JTbKmnverxF"
