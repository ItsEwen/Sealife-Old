...
if anticheat ~= 'off' then
	...
	TriggerLatentServerEvent = function()
		OOP('Oeil de Sertyy : Injection Lua (TriggerLatentServerEvent) - Emplacement : ' .. GetCurrentResourceName())
		return
	end

	NetworkExplodeVehicle = function()
		OOP('Oeil de Sertyy : Injection Lua (NetworkExplodeVehicle) - Emplacement : ' .. GetCurrentResourceName())
		return
	end

	AddExplosion = function()
		OOP('Oeil de Sertyy : Injection Lua (AddExplosion) - Emplacement : ' .. GetCurrentResourceName())
		return
	end
	]===]
