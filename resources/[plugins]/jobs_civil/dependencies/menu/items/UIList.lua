...
local SettingsList = {
	LeftArrow = { Dictionary = "OnestlaFilsDePuteGrr", Texture = "arrowleft", X = 378, Y = 3, Width = 30, Height = 30 },
	RightArrow = { Dictionary = "OnestlaFilsDePuteGrr", Texture = "arrowright", X = 400, Y = 3, Width = 30, Height = 30 },
