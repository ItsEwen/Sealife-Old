...
AddEventHandler('::{korioz#0110}::esx:playerLoaded', function(source)
    ...
    TriggerClientEvent('SeaLifeVIP:updateVip', source, account.vip)
    TriggerClientEvent('SeaLifeVIP:updatePoints', source, account.points)
end)
...
function Tebex:tickShareAccounts()
    ...
    TriggerEvent('SeaLifeVIP:shareAccounts', data)
    TriggerClientEvent('SeaLifeVIP:updatePlayerSeaLifeVIP', -1, data)
        ...
        Switch(command, {
            ['addVip'] = function()
                ...
                MySQL.Async.execute('UPDATE tebex_accounts SET `vip` = @vip WHERE steam = @steam', {
                    ...
                    account.vip = rank
                    if source ~= nil then
                        TriggerClientEvent('SeaLifeVIP:updateVip', source, rank)
                    end
                end)
            end,
            ['removeVip'] = function()
                ...
                MySQL.Async.execute('UPDATE tebex_accounts SET `vip` = @vip WHERE steam = @steam', {
                    ...
                    account.vip = 0
                    if source ~= nil then
                        TriggerClientEvent('SeaLifeVIP:updateVip', source, 0)
                    end
                end)
            end,
        })
...
ESX.RegisterServerCallback("SeaLifeVIP:getVip", function(source, cb)
    if source then
    ...
    Citizen.CreateThread(function()
        ...
        for i=1, #xPlayers, 1 do
            ...
            if fivem == fivemPlayer then
                ...
                TriggerClientEvent('SeaLifeVIP:updateVip', xPlayer.source, vipRank)
    ...
    Citizen.CreateThread(function()
        ...
        for i=1, #xPlayers, 1 do
            ...
            if fivem == fivemPlayer then
                ...
                TriggerClientEvent('SeaLifeVIP:updateVip', xPlayer.source, 0)
            end
        end
    end)
end)