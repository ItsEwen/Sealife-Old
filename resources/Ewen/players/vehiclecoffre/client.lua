...
function getItemWeight(item)
	...
	if item ~= nil then
		itemWeight = VehicleCoffre.DefaultWeight
		if VehicleCoffre.localWeight[item] ~= nil then
			itemWeight = VehicleCoffre.localWeight[item]
		end
	end
...
RegisterNetEvent('ewen:openvehiclecoffre')
AddEventHandler('ewen:openvehiclecoffre', function()
