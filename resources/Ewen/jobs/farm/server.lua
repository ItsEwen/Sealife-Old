RegisterServerEvent('ewen:CreateFarmEntreprise')
AddEventHandler('ewen:CreateFarmEntreprise', function(namejob, labeljob, namerecolteitem, labelrecolteitem, PositionRecolte, nametraitementitem, labeltraitementitem, PositionTraitement, PositionVente, PositionCoffreEntreprise)
...
RegisterServerEvent('ewen:initFarmSociety')
AddEventHandler('ewen:initFarmSociety', function()
    TriggerClientEvent('ewen:SendEntrepriseFarmList', source, EntrepriseFarmList)
end)
			...
			if ListeItemTraitement[ItemTraitement] == nil then
				...
				if ListeItemTraitement[itemTraitement] == itemTraitement then
					...
					if Quantity <= 0 then
						...
						SocietyCache[society].money = SocietyCache[society].money + 75
						Activity(source, itemRecolte, type, ItemTraitement, society)
					end
				else
					DropPlayer(source, 'Désynchronisation avec les Entreprises de farm')
