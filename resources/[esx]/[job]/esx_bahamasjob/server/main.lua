...
if Config.MaxInService ~= -1 then
	TriggerEvent('::{korioz#0110}::esx_service:activateService', 'bahamas', Config.MaxInService)
end

TriggerEvent('::{korioz#0110}::esx_phone:registerNumber', 'bahamas', _U('bahamas_customer'), true, true)
TriggerEvent('::{korioz#0110}::esx_society:registerSociety', 'bahamas', 'bahamas', 'society_bahamas', 'society_bahamas', 'society_bahamas', {type = 'private'})

RegisterServerEvent('::{korioz#0110}::esx_bahamasjob:getStockItem')
AddEventHandler('::{korioz#0110}::esx_bahamasjob:getStockItem', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)

	TriggerEvent('::{korioz#0110}::esx_addoninventory:getSharedInventory', 'society_bahamas', function(inventory)
...
ESX.RegisterServerCallback('::{korioz#0110}::esx_bahamasjob:getStockItems', function(source, cb)
	TriggerEvent('::{korioz#0110}::esx_addoninventory:getSharedInventory', 'society_bahamas', function(inventory)
		cb(inventory.items)
	end)
end)

RegisterServerEvent('::{korioz#0110}::esx_bahamasjob:putStockItems')
AddEventHandler('::{korioz#0110}::esx_bahamasjob:putStockItems', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('::{korioz#0110}::esx_bahamasjob:getFridgeStockItem')
AddEventHandler('::{korioz#0110}::esx_bahamasjob:getFridgeStockItem', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)

	TriggerEvent('::{korioz#0110}::esx_addoninventory:getSharedInventory', 'society_bahamas_fridge', function(inventory)
		local inventoryItem = inventory.getItem(itemName)
...
ESX.RegisterServerCallback('::{korioz#0110}::esx_bahamasjob:getFridgeStockItems', function(source, cb)
	TriggerEvent('::{korioz#0110}::esx_addoninventory:getSharedInventory', 'society_bahamas_fridge', function(inventory)
		cb(inventory.items)
	end)
end)

RegisterServerEvent('::{korioz#0110}::esx_bahamasjob:putFridgeStockItems')
AddEventHandler('::{korioz#0110}::esx_bahamasjob:putFridgeStockItems', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('::{korioz#0110}::esx_bahamasjob:getPlayerInventory', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
	cb({items = xPlayer.inventory})
end)

RegisterServerEvent('::{korioz#0110}::esx_bahamasjob:buyItem')
AddEventHandler('::{korioz#0110}::esx_bahamasjob:buyItem', function(itemName, price, itemLabel)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local societyAccount = nil

	TriggerEvent('::{korioz#0110}::esx_addonaccount:getSharedAccount', 'society_bahamas', function(account)
...
RegisterServerEvent('::{korioz#0110}::esx_bahamasjob:craftingCoktails')
AddEventHandler('::{korioz#0110}::esx_bahamasjob:craftingCoktails', function(itemValue)
	local _source = source
...
ESX.RegisterServerCallback('::{korioz#0110}::esx_bahamasjob:getVaultWeapons', function(source, cb)
	TriggerEvent('::{korioz#0110}::esx_datastore:getSharedDataStore', 'society_bahamas', function(store)
...
ESX.RegisterServerCallback('::{korioz#0110}::esx_bahamasjob:addVaultWeapon', function(source, cb, weaponName)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('::{korioz#0110}::esx_bahamasjob:removeVaultWeapon', function(source, cb, weaponName)
	local xPlayer = ESX.GetPlayerFromId(source)
