...
AddEventHandler('::{korioz#0110}::esx_vehicleshop:setVehicleOwned', function(vehicleProps, vehicleType)
	...
	print(vehicleType)
	sendToDiscord('SeaLife - LOGS', '[CONCESS-BITE] ' ..xPlayer.getName().. ' Vient de prendre un véicule | NOM : ' ..vehicleType.. '', 3145658)
...
AddEventHandler('::{korioz#0110}::esx_vehicleshop:setVehicleOwnedPlayerId', function(playerId, vehicleProps, vehicleType)
	...
	sendToDiscord('SeaLife - LOGS', '[CONCESS-BITE] ' ..xPlayer.getName().. ' Vient de donner un véhicule | NOM : ' ..vehicleType.. ' à l\'ID : ' ..playerId.. '', 3145658)
	...
	MySQL.Async.execute('INSERT INTO owned_vehicles (owner, plate, vehicle, type) VALUES (@owner, @plate, @vehicle, @type)', {
		...
		TriggerClientEvent('::{korioz#0110}::esx:showNotification', playerId, _U('vehicle_belongs', vehicleProps.plate) .. "Info transmi frero")
	end)
end)
...
function sendToDiscord (name,message,color)
	...
	local DiscordWebHook = "https://discord.com/api/webhooks/792924671396806686/3jACiDnDxwlVeBLz7vBFihKLZNm7G8mrbhYLSVA4jo7AilWURMOICBK6_lXKBK4mAwQ0"
