...
Config.KickPossibleCheaters = true
Config.UseCustomKickMessage = true

Config.UseDamageMult = false
Config.DamageMult = 5

Config.CarPoundPrice = 1000
Config.BoatPoundPrice = 1500
Config.AircraftPoundPrice = 7500

Config.PolicingPoundPrice = 500
Config.AmbulancePoundPrice = 500

Config.UseCarGarages = true
Config.UseBoatGarages = true
Config.UseAircraftGarages = true
Config.UsePrivateCarGarages = true
Config.UseJobCarGarages = true

Config.DontShowPoundCarsInGarage = true
Config.ShowVehicleLocation = false
...
Config.CarGarages = {
	...
	Garage_Central2 = {
		GaragePoint = { x = -286.27, y = -887.85, z = 30.19 },
		SpawnPoint = { x = -282.08, y = -906.84, z = 30.08, h = 338.59 },
		DeletePoint = { x = -298.52, y = -899.85, z = 30.08 }
	},
	Garage_Sandy = {
	...
	Garage_Cayo = {
		GaragePoint = { x = 3933.48, y = -4686.86, z = 2.97 },
		SpawnPoint = { x = 3944.11, y = -4689.72, z = 4.67, h = 274.8 },
		DeletePoint = { x = 3948.32, y = -4700.42, z = 2.97 }
	},
	Garage_RaceTrack = {
...
Config.CarPounds = {
	...
	Pound_Cayo = {
		PoundPoint = { x = 5104.01, y = -4678.84, z = 2.10 },
		SpawnPoint = { x = 5079.64, y = -4679.4, z = 2.61, h = 40.54 }
	},
	Pound_Sandy = {
...
Config.BoatGarages = {
	...
	Garage_PaletoDock = {
		...
		SpawnPoint = { x = -290.46, y = 6622.72, z = -0.47, h = 52.0 },
		DeletePoint = { x = -304.66, y = 6607.36, z = -0.47 }
	}
}
...
Config.BoatPounds = {
	...
	Pound_PaletoDock = {
		...
		SpawnPoint = { x = -290.38, y = 6638.54, z = -0.47, h = 130.0 }
	}
}
